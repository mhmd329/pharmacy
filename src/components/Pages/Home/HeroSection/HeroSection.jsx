  ...
  return (
    <div className={`${styles["hero-section"]} h-screen flex justify-center items-center`}>
      <div className="wrapper flex flex-col items-center gap-3">
        <h2 className={`${styles["heading"]} lg:text-[50px] text-[35px] text-center`}>
          كل ما تحتاجينه للصحة والجمال في مكان واحد
        </h2>
        <p className={`${styles["desc"]} lg:text-[24px] text-[16px] text-center`}>
          منتجات أصلية من أفضل العلامات التجارية، مع ضمان الجودة والنصائح الصيدلانية
        </p>
